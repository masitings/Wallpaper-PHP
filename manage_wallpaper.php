<?php 
    ...
    $sql_query="SELECT * FROM tbl_wallpaper ORDER BY tbl_wallpaper.`id` DESC LIMIT $start, $limit";
            ...
            <div class="pb-card__head d-sm-flex align-items-sm-center">
                ...
                <div class="pb-card__head__option">
                    <div class="pb-card__head__option__item">
                        <a href="add_wallpaper.php?add=yes" class="btn btn-sm btn-primary">+ <span class="d-none d-sm-inline-block">Add Wallpaper</span></a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="pb-card-post">
                                    <div class="bottom_block">
                                        ...
                                        <ul>
                                            <li><a href="add_wallpaper.php?wallpaper_id=<?php echo $row['id'];?>" target="_blank" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit"><i class="fa fa-edit"></i></a></li> 
                                    ...
                                    <span><img class="image-post" src="categories/<?php echo $row['cat_id'];?>/<?php echo $row['image'];?>"></span>
                                </div>
                            </div>
                        <?php $i++; } ?>
                    </div>
